...
export const onTransaction: OnTransactionHandler = async ({
  ...
  const TENDERLY_API = "https://api.tenderly.co/api/v1/account/" +
    TENDERLY_USER + "/project/" + TENDERLY_PROJECT + "/simulate";
  ...
  let approvalForAllEventCount = 0;
  ...
  const insights = {
    'Critical events': (transferEventCount + approvalEventCount + approvalForAllEventCount > 0),
